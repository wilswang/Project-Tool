...
```bash
# 執行 JiraTool
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool <command> [arguments] [options]

# 顯示說明
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool --help
```
...
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-issue <issueKey>

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-issue SACRIC-1020
```

#### 2. get-comments - 取得 Issue 留言
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-comments <issueKey>

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-comments SACRIC-1020
```

#### 3. get-transitions - 取得可用的狀態轉換選項
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-transitions <issueKey>

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool get-transitions SACRIC-1020
```

#### 4. post-comment - 新增留言
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool post-comment <issueKey> <commentText> [options]

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool post-comment SACRIC-1020 "This is a comment"

# 測試模式（不實際發送）
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool post-comment SACRIC-1020 "Test comment" -t
```

#### 5. transition-issue - 轉換 Issue 狀態
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool transition-issue <issueKey> <transitionKey> [options]

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool transition-issue SACRIC-1020 TO_DEV

# 測試模式
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool transition-issue SACRIC-1020 TO_DEV --testMode
```
...
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool start-jira-issue <issueKey> [options]

# 範例
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool start-jira-issue SACRIC-1020

# 測試模式（跳過狀態檢查和轉換）
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool start-jira-issue SACRIC-1020 -t
```
...
```bash
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool enhanced-search <issueList> [templatePath]

# 範例：單一 issue
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool enhanced-search SACRIC-1020

# 範例：多個 issues（逗號分隔，不加空格）
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool enhanced-search SACRIC-1020,SACRIC-1021

# 範例：指定自訂 template 路徑
java -cp target/Project-Tool-1.2.4-jar-with-dependencies.jar tool.http.JiraTool enhanced-search SACRIC-1020 ./my-search.json
```
...
```
/deploy/
├── Project-Tool-1.2.4-jar-with-dependencies.jar
